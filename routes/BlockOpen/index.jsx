...
import {fetchTransaction} from "~store/slices/getTransactionSlice";
...
import {toValoper} from "~utils/formatting/validators";
import {toBase64} from "@cosmjs/encoding";
import {sha256} from "~utils/formatting/crypto";
                                        ...
                                        <th>Period</th>
                                            ...
                                            <tbody>
                                                ...
                                                {signature.blockIdFlag !== "BLOCK_ID_FLAG_ABSENT" ? (<>
                                                    ...
                                                    <td>
                                                        <span
                                                            className="font-book">{getDateDifferent(signature.timestamp, new Date())}</span>
                                                    </td>
                                                </>
